            ...
            <div class="login-form" id="loginForm">
                ...
                <form action="./endpoint/login.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <a>Lupa Password? <a  class="switch-form-link" href="http://localhost/otp/forgot-password.php">Here.</a></a>
                        <button type="submit" class="btn btn-secondary login-btn form-control" >Login</button>
                        <br/>
                        <p id="register">No Account? Register <span  class="switch-form-link" onclick="showRegistrationForm()">Here.</span></p>
                    </form>
            </div>
